...
const (
	CPUImage = "determinedilia/environments:py-3.8-pytorch-1.9-lightning-1.3-tf-2.4-cpu-93f6e54"
	GPUImage = "determinedilia/environments:cuda-11.1-pytorch-1.9-lightning-1.3-tf-2.4-gpu-93f6e54"
)
